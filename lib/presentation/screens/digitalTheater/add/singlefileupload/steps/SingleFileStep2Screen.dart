...
class SingleFileUploadStep2Screen extends StatefulWidget {
  const SingleFileUploadStep2Screen({super.key});

  @override
  _SingleFileUploadStep2ScreenState createState() => _SingleFileUploadStep2ScreenState();
}

class _SingleFileUploadStep2ScreenState extends State<SingleFileUploadStep2Screen>
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Consumer<Step2SFUploadProvider>(
        builder: (context, stepProvider, _) {
          print("Trailer Type :${stepProvider.trailerType}");
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Hero(
                  tag: 'singlefileupload',
                  child: _buildHeading("Upload poster for the movie")),
              SizedBox(
                height: 10.h,
              ),
              _buildDescription(
  ...
  Future<void> _pickPoster() async {
    final provider = Provider.of<Step2SFUploadProvider>(context,listen: false);
                    ...
                    child: Column(
                      ...
                      children: [
                        if (stepProvider.pickedFile != null) ...[
                          ...
                          SizedBox(height: 5.h),
                          Text(
                            '${(stepProvider.pickedFile!.lengthSync() / 1024)
                                .ceil()} KB',
                            style: TextStyle(
