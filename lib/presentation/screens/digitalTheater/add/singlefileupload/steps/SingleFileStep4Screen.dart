...
class SingleFileUploadStep4Screen extends StatefulWidget {
  const SingleFileUploadStep4Screen({super.key});

  @override
  State<SingleFileUploadStep4Screen> createState() => _SingleFileUploadStep4ScreenState();
}

class _SingleFileUploadStep4ScreenState extends State<SingleFileUploadStep4Screen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<Step4SFUploadProvider>(context, listen: false);
  ...
  void _saveCastMembers(Step4SFUploadProvider provider) async {
  ...
  Widget build(BuildContext context) {
    return Consumer<Step4SFUploadProvider>(
