...
class MultipleFileStep1Screen extends StatefulWidget {
  const MultipleFileStep1Screen({super.key});

  @override
  _MultipleFileStep1ScreenState createState() => _MultipleFileStep1ScreenState();
}

class _MultipleFileStep1ScreenState extends State<MultipleFileStep1Screen> {
  String dtID = '';
  ...
  Widget build(BuildContext context) {
    return Consumer<MultipleFileUploadStep1Provider>(
      builder: (context, fileUploadProvider, child) {
        final dtProvider = Provider.of<MultipleFileUploadMainProvider>(context,
            listen: false);
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(showYear),
            Icon(Icons.calendar_month_outlined,color: Theme.of(context).colorScheme.surface,),
          ],
        ),
      ),
    );
