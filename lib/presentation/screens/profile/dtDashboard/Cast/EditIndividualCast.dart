...
class EditIndividualCast extends StatefulWidget {
...
class _EditIndividualCastState extends State<EditIndividualCast> {
  File? _imageFile;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Edit Cast Details"),
        actions: [
          IconButton(
      ...
      body: Padding(
        ...
        child: _buildCastMemberRow(),
      ),
    );
  }

  Widget _buildCastMemberRow() {
    return Container(
      height: 450.h,
