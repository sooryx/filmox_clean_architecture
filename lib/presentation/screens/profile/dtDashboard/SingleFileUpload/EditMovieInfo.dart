...
class EditMovieInfo extends StatefulWidget {
  String? dropDownMovieType;
  String? Movie;
  String? dtId;

  EditMovieInfo({
    required this.dropDownMovieType,
    required this.Movie,
    this.dtId,
    super.key,
  });
  ...
  @override
  State<EditMovieInfo> createState() => _EditMovieInfoState();
}

class _EditMovieInfoState extends State<EditMovieInfo>
  ...
  void initState() {
    super.initState();
    _trailerUrlController = TextEditingController(text: widget.Movie);
            ...
            children: [
              SizedBox(
                ...
                child: CommonWidgets.CustomDropDown(
                    ...
                    selectedValue: widget.dropDownMovieType,
                    onChanged: (value) => {
                      setState(() {
                        widget.dropDownMovieType = value;
                      })
                    },
                    buttonWidth: 160.w,
                    buttonHeight: 60.h),
