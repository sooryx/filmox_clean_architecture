...
import '../dashboardmainscreen/dt_dashboard_helper.dart';
import 'AddCast.dart';
    ...
    return Scaffold(
        ...
        body: Consumer<DTDashboardProvider>(
          builder: (context, digitalProvider, state) {
            final digitalTheater = digitalProvider.digitalTheaterDashBoardEntity;
            final cast = digitalTheater?.cast;

            if (cast == null) {
              // If the digitalTheater or cast is null, show a loading or error message
              return Column(
                    ...
                    itemBuilder: (context, index) {
                      return Dismissible(
                        ...
                        onDismissed: (direction) async {
                          ...
                          try {
                            await digitalProvider.deleteCastData(
                              context: context,
                              id: widget.dtId,
